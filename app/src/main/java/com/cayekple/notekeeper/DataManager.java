...
import com.cayekple.notekeeper.NoteKeeperDatabaseContract.CourseInfoEntry;

import java.util.ArrayList;
import java.util.List;

import static com.cayekple.notekeeper.NoteKeeperDatabaseContract.*;
